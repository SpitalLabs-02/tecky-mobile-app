...
const Information19 = () => {
  ...
  const questions = [
    {
      id: "1",
      text: "I enjoy identifying business needs and developing solutions to address them.",
      options: [1, 2, 3, 4, 5],
      rowResponses: true, 
    ...
    {
      id: "2",
      text: "I am interested in learning about business operations and processes.",
      options: [1, 2, 3, 4, 5],
      rowResponses: true,
    ...
    {
      id: "3",
      text: "I enjoy analyzing data to inform business decisions.",
      options: [1, 2, 3, 4, 5],
      rowResponses: true,
    ...
    {
      id: "4",
      text: "I enjoy exploring and collaborating with others to understand business requirements.", 
      options: [1, 2, 3, 4, 5],
      rowResponses: true,
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.backNextContainer}>
          ...
          {/* Next */}
          <Link href={"/information20"} style={styles.button}>
