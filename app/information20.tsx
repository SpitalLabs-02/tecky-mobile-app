...
const Information20 = () => {
  ...
  const questions = [
    {
      id: "1",
      text: "I enjoy developing and reviewing business cases and proposals.",
      options: [1, 2, 3, 4, 5],
      rowResponses: true, 
    ...
    {
      id: "2",
      text: "I am interested in using business analysis to drive organizational change and improvement.",
      options: [1, 2, 3, 4, 5],
      rowResponses: true,
    ...
    {
      id: "3",
      text: "HOW RELAXED ARE YOU WORKING WITH IMAGES (MOTION AND STATIC)?",
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.backNextContainer}>
          ...
          {/* Next */}
          <Link href={"/information21"} style={styles.button}>
